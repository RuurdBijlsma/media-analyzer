...
from media_analyzer.data.interfaces.ml_types import BaseBoundingBox
...
def draw_bounding_box(
    ...
    top_left = (int(box_x * img_width), int(box_y * img_height))
    bottom_right = (int((box_x + box_width) * img_width), int((box_y + box_height) * img_height))
